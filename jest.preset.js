...
export default {
  ...
  transformIgnorePatterns: ['node_modules/(?!(\\.pnpm)|(serialize-error)|(exit-hook)|(chalk)|(find-cache-dir)|(pkg-dir)|(find-up)|(locate-path)|(p-locate)|(p-limit)|(yocto-queue)|(path-exists)|(change-case)|(uuid))'],
