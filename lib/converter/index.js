const { stringify: stringifyJson, parse: parseJson } = require('./json.js');
const { stringify: stringifyMarkdown, parse: parseMarkdown } = require('./markdown.js');
const { stringify: stringifyToml, parse: parseToml } = require('./toml.js');
const { stringify: stringifyYaml, parse: parseYaml } = require('./yaml.js');
